...
<div class="divcss5">
  <%
  	conn2 conn = new conn2();
    String str = request.getAttribute("teString").toString();
    System.out.println("页面数据"+str);
    List<model> downExcel2 = conn.Show(str);
  %>
  ...
  out.println("<tr><th>"+downExcel2.get(i).getEname()+
		  ...
		  "</th>"+"<th>"+"<img style='height:200px;width:200px;' src='data:image/jpg;base64,"+downExcel2.get(i).getImageurl()+".jpg"+"' />"+"</th></tr>");
  i++;
  }
  %>
  </table>
