...
namespace Kingdee.Samples.Integration.WebApi
{
    public partial class Form1 : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            Console.WriteLine(string.Format("返回结果：{0}", res));
                        ...
                        case "自定义服务":
                            {
                                ...
                                return client.Execute<string>(service, new object[] { this.txtData.Text , this.txtFormId.Text });
                            }
                        case "自定义服务查看":
                            {
                                service = "Test01.ServicesStub.Class1.ExecuteService,Test01.ServicesStub";
                                return client.Execute<string>(service, new object[] { this.txtData.Text, this.txtFormId.Text });
                            }
                        case "自定义服务保存":
                            {
                                service = "Test02.ServicesStub.Class1.ExecuteService,Test02.ServicesStub";
                                return client.Execute<string>(service, new object[] { this.txtData.Text, this.txtFormId.Text });
                            }
                    }
                    //this.txtData.Text = "{\"Number\":556}";
        ...
        private void txtDbId_TextChanged(object sender, EventArgs e)
        {
